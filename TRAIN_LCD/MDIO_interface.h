...
/*This function is used to set a specific pin status [OUTPUT - INPUT FLOAT - INPUT PULLUP]*/
void mdio_setPinStatus(u8_t au8_port, u8_t au8_pin, u8_t au8_status);

/*This function is used to generate [0 or 1] over a specific pin*/
void mdio_setPinValue(u8_t au8_port, u8_t au8_pin, u8_t au8_value);

/*This function is used to toggle pin value [0 -> 1, 1 -> 0] over a specific pin*/
void mdio_togglePinValue(u8_t au8_port, u8_t au8_pin);

/*This function is used to get the value of a specific pin*/
